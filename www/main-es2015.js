...
module.exports = __webpack_require__(/*! C:\pro\MTKDelivery\HadimDelivery\src\main.ts */"zUnb");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, authServices, alertCtrl, modalService) {
...
let AuthService = class AuthService {
    ...
    signUpUser(email, password) {
        const usersObj = this.db.collection('Account', ref => ref.where('email', '==', email)
            .where('password', '==', password)).snapshotChanges();
        this.usersList = usersObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(changes => changes.map(a => {
...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | menu-menu-module */[__webpack_require__.e("default~driver-history-driver-history-module~location-location-module~menu-menu-module~restaurant-hi~a290b5de"), __webpack_require__.e("common"), __webpack_require__.e("menu-menu-module")]).then(__webpack_require__.bind(null, /*! ./menu/menu.module */ "19mU")).then(m => m.MenuPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'signup',
        loadChildren: () => Promise.all(/*! import() | signup-signup-module */[__webpack_require__.e("default~driver-history-driver-history-module~location-location-module~menu-menu-module~restaurant-hi~a290b5de"), __webpack_require__.e("common"), __webpack_require__.e("signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "T9iC")).then(m => m.SignupPageModule)
    },
    {
        path: 'user',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | signup-customer-signup-customer-module */[__webpack_require__.e("default~driver-history-driver-history-module~location-location-module~menu-menu-module~restaurant-hi~a290b5de"), __webpack_require__.e("common"), __webpack_require__.e("signup-customer-signup-customer-module")]).then(__webpack_require__.bind(null, /*! ./signup-customer/signup-customer.module */ "Tftg")).then(m => m.SignupCustomerPageModule)
    },
    {
