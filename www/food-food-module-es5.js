          ...
          value: function selectRestaurant($event) {
            ...
            if ($event !== undefined) {
              this.foodService.getAllFood().subscribe(function (res) {
                ...
                _this3.listOfFood = res.filter(function (c) {
                  return c.restaurantId == restaurant.accountId;
                });
                _this3.listOfCategoryFilter = _this3.listOfCategory.filter(function (c) {
                  return c.restaurantId == $event;
                });

                if (_this3.listOfCategoryFilter.length > 0) {
                  _this3.SelectedCategoryId = _this3.listOfCategoryFilter[0].id;
                }
              });
            }
          }
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this5.foodService.removeFood(food.id);
