(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-details-account-details-module"], {
    ...
    /***/
    function ToN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AccountDetailsPageRoutingModule", function () {
        return AccountDetailsPageRoutingModule;
      });
      /* harmony import */
      ...
      var _account_details_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var AccountDetailsPageRoutingModule = function AccountDetailsPageRoutingModule() {
        _classCallCheck(this, AccountDetailsPageRoutingModule);
      };

      AccountDetailsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function HO9D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AccountDetailsPage", function () {
      ...
      var _raw_loader_account_details_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./account-details.page.html */
      "ricU");
      /* harmony import */


      var _account_details_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./account-details.page.scss */
      "yGUt");
      /* harmony import */
      ...
      var AccountDetailsPage = /*#__PURE__*/function () {
        function AccountDetailsPage(fb, platform, accountService) {
          _classCallCheck(this, AccountDetailsPage);
        ...
        _createClass(AccountDetailsPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.accountService.getAllAccount().subscribe(function (res) {
              _this.regform.get('FullName').setValue(res.find(function (c) {
                return c.id == id;
              }).FullName);

              _this.regform.get('phonenumber').setValue(res.find(function (c) {
                return c.id == id;
              }).phonenumber);

              _this.regform.get('email').setValue(res.find(function (c) {
                return c.id == id;
              }).email);

              _this.regform.get('password').setValue(res.find(function (c) {
                return c.id == id;
              }).password);
            });
            this.regform = this.fb.group({
      ...
      AccountDetailsPage.ctorParameters = function () {
        return [{
      ...
      AccountDetailsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function a9TH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AccountDetailsPageModule", function () {
      ...
      var _account_details_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./account-details-routing.module */
      "4ToN");
      /* harmony import */


      var _account_details_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./account-details.page */
      "HO9D");

      var AccountDetailsPageModule = function AccountDetailsPageModule() {
        _classCallCheck(this, AccountDetailsPageModule);
      };

      AccountDetailsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _account_details_routing_module__WEBPACK_IMPORTED_MODULE_5__["AccountDetailsPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
    ...
    /***/
    function ricU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function yGUt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=account-details-account-details-module-es5.js.map