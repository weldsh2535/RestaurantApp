  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
    ...
    function mdzQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var AccountPage = /*#__PURE__*/function () {
        function AccountPage(fb, accountService, alertController, platform) {
        ...
        _createClass(AccountPage, [{
          ...
          value: function selectType(event) {
            ...
            this.accountService.getAllAccount().subscribe(function (res) {
              if (active !== "") {
                _this2.listOfAccount = res.filter(function (c) {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this4.accountService.removeAccount(account.id);

                            _this4.regform.reset();

                            _this4.accountId = null;
                          }
                        }]
                      });
