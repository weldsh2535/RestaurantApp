      ...
      var DetailsPage = /*#__PURE__*/function () {
        ...
        _createClass(DetailsPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.orderService.RestaurantId.next(this.id); // Set the header position for sticky slides 
          ...
          value: function getCategory() {
            ...
            this.categoryService.getAllCategory().subscribe(function (res) {
              _this2.listOfCategory = res.filter(function (c) {
                return c.restaurantId == _this2.resId;
